package update_schedule_contract
...
type UseCase interface {
	Execute(ctx context.Context, doctorID uint, scheduleID uint, request *schedule_dto.UpdateScheduleRequest) (*entities.Schedule, error)
}
